...
export function HomeScreen({ session, navigate, notify }) {
  ...
  return (
    <div className="screen home-screen">
      <div className="home-topline"><div><span className="eyebrow">NEARBY GROOMING</span><h1>Hi {firstName(userName)} <span className="wave">✦</span></h1><p className="muted-line"><LocateFixed size={14} /> {location ? 'Using your current location' : 'Discover trusted specialists around you'}</p></div><div className="home-actions"><GenderToggle value={gender} onChange={setGender} /></div></div>
