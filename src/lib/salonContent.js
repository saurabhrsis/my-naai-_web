export const SALON_ABOUT_CONTENT = {
  ...
  sections: [
    ...
    { title: 'A better local discovery layer', text: 'Be visible to customers searching nearby and build trust with clear information and reviews.' },
  ],
};

export const SALON_FAQ_CONTENT = {
  title: 'Partner FAQs',
  eyebrow: 'PARTNER HELP',
  sections: [
    { title: 'How do I update my services?', text: 'Open Salon account, choose Edit salon profile, then update your menu, prices or durations.' },
